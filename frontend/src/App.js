...
import AllChats from "../../frontend/src/component/Admin/AllChats";
import CreateBlog from "../../frontend/src/component/blog/CreatBlog";
import EditBlog from "../../frontend/src/component/blog/EditBlog";
import CustomerBlog from "../../frontend/src/component/blog/CustomerBlog";
...
import ReportList from "../../frontend/src/component/Report/ReportList"
import BlogsList from '../../frontend/src/component/blog/BlogsList';
     ...
     <Router>
      ...
      {stripeApiKey && (
       ...
       <Switch>
         ...
         <Route exact path="/blogs" component={CustomerBlog} />
         ...
         <ProtectedRoute isAdmin={true} exact path="/admin/chats" component={AllChats} />
         <ProtectedRoute isAdmin={true} exact path="/admin/blogs" component={BlogsList} />
         <ProtectedRoute isAdmin={true} exact path="/create-blog" component={CreateBlog} />
         <ProtectedRoute isAdmin={true} exact path="/edit-blog/:id" component={EditBlog} />
        <ProtectedRoute isAdmin={true} exact path="/admin/notes" component={Notelist} />
        <ProtectedRoute isAdmin={true} exact path="/create-note" component={CreateNote} />
        <ProtectedRoute isAdmin={true} exact path="/edit-note/:id" component={UpdateNote} />
        <ProtectedRoute isAdmin={true} exact path="/admin/reports" component={ReportList} />
         <Route component={
